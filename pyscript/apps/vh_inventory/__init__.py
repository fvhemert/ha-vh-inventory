...
_CATEGORY_RULES = [
    ("Soep & bouillon",
     ["cup-a-soup", "cup a soup", "erwtensoep", "tomatensoep", "bouillon",
      "maggi ind", "romige tomatensoep"]),
    ("Diepvries",
     ["magnum", "raket", "festini", "diepvries"]),
    ("Bier, wijn & sterke drank",
     ["bier", "radler", "grimbergen", "hertog jan", "amstel"]),
    ("Persoonlijke verzorging",
     ["wattenschijf", "wattenstaaf", "deodorant", "antitranspirant",
      "handzeep", "nivea", "sanex"]),
    ("Huishouden & schoonmaak",
     ["dreft", "wasmiddel", "toiletpapier", "keukenpapier", "keuken papier",
      "huishoudpapier", "tissues", "badkamerreiniger", "afvalzak"]),
    ("Kaas, vleeswaren & tapas",
     ["brie", "strooikaas", "parmezaan", "parmesan", "pate", "paté",
      "vleeswaren"]),
    ("Zuivel, eieren & boter",
     ["melk", "yoghurt", "boter", "chocomel", "haferdrink", "alpro",
      "breaker", "eieren"]),
    ("Brood, crackers & beleg",
     ["brood", "broodje", "cracotte", "wasa", "knäcke", "toast", "tostada",
      "cracker", "triangel", "naan", "pinsa", "piadina", "pan tostado",
      "tapas toast", "bruschetta", "knackebrod", "pan con ajo", "dipstok",
      "rozijnenbol", "pindakaas", "hagelslag", "hagel", "nutella",
      "confiture", "aardbeien", "appelstroop", "honing", "maïswafel",
      "maiswafel", "desem", "kaiser"]),
    ("Kruiden & specerijen",
    ...
    ("Aardappelen, groente & fruit",
     ["aardappel", "roast potatoes", "uien", "knoflook", "waspeen", "wortel",
      "roerbakmix"]),
    ("Vlees, vis & vega",
     ["kipfilet", "rundvlees gemalen", "rundergehakt", "vegetarisch", "vega"]),
    ("Bakken & zoetstoffen",
     ["zoetstof", "poedersuiker", "rietsuiker", "allesbinder",
      "maizena", "maïzena", "baking soda", "paneermeel", "zandeeg",
      "tortelet", "pannekoek", "pannenkoek", "mix om",
      "mix voor stroopwafel", "tafelzoet", "kaneelsuiker"]),
    ("Pasta, rijst & noedels",
     ["macaroni", "lasagne", "spaghetti", "gnocchi", "rijst", "rice ",
      "rice sticks", " rice", "couscous", "noodle", "noedel", "wok noodles",
      "pad thai", "zilvervlies"]),
    ("Conserven (groente, vis & vlees)",
     ["bonen", "mais", "maïs", "maizbio", "doperwt", "witte bonen", "kidney",
      "ananas", "appelmoes", "sardine", "tonijn", "crispy maïs",
      "crispy mais", "knakworst", "hotdog", "worst", "snijbonen", "atjar"]),
    ("Sauzen, olie & smaakmakers",
     ["ketchup", "mosterd", "senf", "satésaus", "saté", "satesaus", "salsa",
      "woksaus", "tomato frito", "sugo", "bolognese", "arrabiat",
      "tomaten saus", "mayonaise", "mayonnaise", "mayo", "teriyaki",
      "sajoer", "rundvlees jus", "dip ", "dressing", "wijko", "fried onion",
      "jakarta", "paniki", "olie", "olijfolie", "black bean"]),
    ("Koek, snoep, chocolade, chips & noten",
     ["chips", "pringles", "nacho", "doritos", "kroepoek", "cassave",
      "javaant", "drop", "mentos", "m&m", "peanut m", "bastogne", "koek",
      "cookie", "biscuit", "notenmix", "paprika sticks", "ovaaltjes",
      "dropfruit", "scheepsknopen", "schoolkrijt", "venco", "sultana"]),
    ("Frisdrank",
     ["coca cola", "coca-cola", "fanta", "frisdrank", "green ice tea"]),
    ("Koffie, thee, sap & siroop",
     ["koffiecup", "ristretto", "lungo", "nescafe", "crema", "lavazza",
      "rooibos", "sterrenmunt", "thee", "grenadine", "sirop", "siroop",
      "appel- en peer", "koffie"]),
]
